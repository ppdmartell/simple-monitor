...
public class HardwareCategoryDto extends CategoryDto {

	public HardwareCategoryDto(String health, String status, String index, String category, String uuid, int pri, int rep,
