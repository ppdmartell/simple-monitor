...
public class KernelCategoryDto extends CategoryDto {

	public KernelCategoryDto(String health, String status, String index, String category, String uuid, int pri, int rep,
